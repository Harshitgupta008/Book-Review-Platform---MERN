        ...
        <>
            <div className="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900">
                ...
                <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
                    <img className="object-cover object-center h-32" src={defaultImage} alt='Woman looking front' />
                </div>
                <div className="text-center mt-2">
                    <h2 className="font-semibold">Harshit gupta</h2>
                </div>
                ...
                <div className="p-4 border-t flex flex-wrap justify-evenly mx-8 mt-2">
                    ...
                    <button className="w-fit h-fit  mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2">Views</button>
                </div>
            </div>
        </>
    )
